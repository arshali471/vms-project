...
from app import upload_rtsp_data, update_rtsp_data, get_rtsp_data, delete_rtsp_data, process_rtsp_data, list_files, serve_file, delete_all_files, api_test, update_algorithm_timings_by_category
from liveFeeds import video_feed, index, stop_stream
...
app.add_url_rule("/stream", view_func=index, methods=['GET'])
app.add_url_rule("/stop_stream/<int:id>", view_func=stop_stream, methods=['POST'])
app.add_url_rule("/update_algorithm_timings_by_category", view_func=update_algorithm_timings_by_category, methods=['PUT'])
